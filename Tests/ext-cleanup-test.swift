...
struct ExtensionCleanupTests {
    ...
    static func sweepTakesOnlyOurWorkspaces() {
        ...
        makeDirectory(roots.temp, "ultracmd-install-ABC123")
        makeDirectory(roots.temp, "ultracmd-install-DEF456")
        makeDirectory(roots.temp, "keep-me")
        makeFile(roots.temp, "unrelated.txt")

        ExtensionCleanup.sweepWorkspaces(in: roots.temp)

        expect(!exists(roots.temp, "ultracmd-install-ABC123"), "a stale workspace is swept")
        expect(!exists(roots.temp, "ultracmd-install-DEF456"), "every stale workspace is swept")
    ...
    static func cleanTakesOnlyOrphans() {
        ...
        makeDirectory(roots.temp, "ultracmd-install-STRAY")
        ...
        expect(!exists(roots.temp, "ultracmd-install-STRAY"), "a stray workspace goes")
