...
struct AIChatTests {
    ...
    static func historyRoundTripsAndRepairsInterruptedReplies() {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("ultracmd-ai-chat-\(UUID().uuidString)", isDirectory: true)
        defer { try? FileManager.default.removeItem(at: directory) }
    ...
    static func savesRewriteOnlyTheStoredTail() {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("ultracmd-ai-tail-\(UUID().uuidString)", isDirectory: true)
        defer { try? FileManager.default.removeItem(at: directory) }
    ...
    static func crashRepairSurvivesTailSaves() {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("ultracmd-ai-repair-\(UUID().uuidString)", isDirectory: true)
        defer { try? FileManager.default.removeItem(at: directory) }
    ...
    static func retentionPrunesByAgeAndCascades() {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("ultracmd-ai-prune-\(UUID().uuidString)", isDirectory: true)
        defer { try? FileManager.default.removeItem(at: directory) }
        let store = ChatHistoryStore(directory: directory)
    ...
    static func leavingAConversationDropsItsStagedImages() {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("ultracmd-ai-staging-\(UUID().uuidString)", isDirectory: true)
        defer { try? FileManager.default.removeItem(at: directory) }
