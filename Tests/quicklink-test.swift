...
struct QuicklinkTests {
    ...
    static let home = "/Users/ultracmd-harness"
    ...
    static func pathDetection() {
        ...
        expect(
            detect("  ~/Projects/UltraCMD  ") == .path("\(home)/Projects/UltraCMD"),
    ...
    static func scratchDirectory() -> URL {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("ultracmd-quicklink-test-\(UUID().uuidString)", isDirectory: true)
