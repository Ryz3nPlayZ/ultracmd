...
struct UninstallTests {
    ...
    static let ownBundleID = "com.ultracmd.app"
    static let ownBundleURL = URL(fileURLWithPath: "/Applications/UltraCMD.app")
    ...
    static func testIdentityRefusal() {
        let byID = UninstallTarget(
            ...
            bundleID: "com.ultracmd.app", displayName: "UltraCMD", bundleName: nil)
        expect(
            UninstallIdentity.make(
                target: byID, otherAppNames: [], ownBundleID: ownBundleID,
                ownBundleURL: ownBundleURL) == nil,
            "UltraCMD refuses to plan its own uninstall by bundle ID")

        let dev = UninstallTarget(
            bundleURL: URL(fileURLWithPath: "/Applications/UltraCMD Dev.app"),
            bundleID: "com.ultracmd.app.dev", displayName: "UltraCMD Dev", bundleName: nil)
        expect(
            UninstallIdentity.make(
                target: dev, otherAppNames: [], ownBundleID: "com.ultracmd.app.dev",
                ownBundleURL: URL(fileURLWithPath: "/Applications/UltraCMD Dev.app")) == nil,
