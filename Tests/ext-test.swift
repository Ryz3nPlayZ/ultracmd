...
struct ExtensionTests {
    ...
    static func runtimeURL() -> URL {
        let candidates = [
            URL(fileURLWithPath: FileManager.default.currentDirectoryPath)
                .appendingPathComponent("UltraCMD/Resources/RaycastRuntime.generated.js"),
    ...
    static func manifestChecks() {
        ...
        // A manifest with no commands isn't an extension UltraCMD can run.
    ...
    static func oauthUnitChecks() {
        ...
        let strayURL = URL(string: "ultracmd://oauth?code=abc&state=xyz")!
        check(
    ...
    static func deepLinkChecks() {
        ...
        let tiny = ExtensionDeepLink.parse(
            url: URL(string: "ultracmd://extensions/linear/linear/create-issue")!)
        check("deeplink mirrors raycast:// as ultracmd://", tiny == canonical)
    ...
    static func runtimeChecks() async {
        ...
        let command = """
            ...
            module.exports.default = function Command() {
              ...
              const filePaths = [
                fileURLToPath("file:///Applications/UltraCMD%20Beta.app"),
              ...
              const encrypted = Buffer.concat([encrypter.update("hello ultracmd"), encrypter.final()]);
        ...
        check(
            ...
            ExtensionAccessoriesView_labelForTest(
                ...
                == "/Applications/UltraCMD Beta.app\n/tmp/a#b.png\n"
        ...
        check(
            ...
            ExtensionAccessoriesView_labelForTest(
                ...
                + "b3075fd6b8c5972dbff3df1655e7c67e,"
                + "hello ultracmd,17d614f379a9359077e95577fd31c20a,ERR_OSSL_BAD_DECRYPT,"
    ...
    static func nodeContractChecks() async {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("ultracmd-archive-\(UUID().uuidString)")
    ...
    static func swiftHelperChecks() async {
        let helper = FileManager.default.temporaryDirectory
            .appendingPathComponent("ultracmd-helper-\(UUID().uuidString)")
    ...
    static func processKillChecks() async {
        let marker = FileManager.default.temporaryDirectory
            .appendingPathComponent("ultracmd-rang-\(UUID().uuidString)")
        ...
        check(
            "exec returns a live pid and process.kill guards UltraCMD itself",
    ...
    static func zlibChecks() {
        let payload = Data(String(repeating: "ultracmd extensions ", count: 64).utf8)
        do {
