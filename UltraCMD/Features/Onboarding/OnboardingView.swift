...
struct OnboardingView: View {
    ...
    private var subtitle: String {
        ...
        case 1: "Let UltraCMD paste items back into the app you were using."
    ...
    private var readyMessage: String {
        if let caps = hotKeys.binding(for: .togglePalette)?.keycaps {
            return "Press \(caps.joined()) anytime to start using UltraCMD."
        }
        return "UltraCMD is ready. Set a shortcut in Settings to summon it."
    }
    ...
    private var shortcutStep: some View {
        ...
        return VStack(alignment: .leading, spacing: Theme.Spacing.md) {
            OnboardingCard {
                OnboardingRow(
                    title: "App Launcher",
                    subtitle: "Press this shortcut to open UltraCMD.",
                ...
                OnboardingRow(
                    ...
                    subtitle: "Start UltraCMD automatically when you log in.",
