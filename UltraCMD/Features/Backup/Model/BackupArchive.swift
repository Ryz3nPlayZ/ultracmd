...
/// Seals a `BackupBundle` directory into one `.ultracmd` file, and opens one back up.
enum BackupArchive {
    static let fileExtension = "ultracmd"
    ...
    enum ArchiveError: LocalizedError, Equatable {
        ...
        var errorDescription: String? {
            ...
            case .cannotRead: return "This file isn't a UltraCMD backup, or it's damaged."
            }
        }
    }
