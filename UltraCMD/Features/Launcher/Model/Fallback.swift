...
enum Fallback: Hashable, Sendable {
    ...
    enum Builtin: String, CaseIterable, Sendable {
        ...
        var command: CommandID {
            ...
            case .quickAddEvent: return .quickAddEvent
            case .newReminder: return .newReminder
            case .startTimer: return .startTimer
            case .searchMaps: return .searchMaps
    ...
    var openVerb: String {
        ...
        case .builtin(.quickAddEvent): return "Add Event"
        case .builtin(.newReminder): return "Add Reminder"
        case .builtin(.startTimer): return "Start Timer"
        case .builtin(.searchMaps): return "Search Maps"
