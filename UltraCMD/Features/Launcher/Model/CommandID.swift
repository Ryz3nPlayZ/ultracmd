...
enum CommandID: String, CaseIterable, Sendable {
    ...
    case translateScreen = "command:translate-screen"
    ...
    case quickAddEvent = "command:quick-add-event"
    case newReminder = "command:new-reminder"
    case startTimer = "command:start-timer"
    case searchMaps = "command:search-maps"
    case searchWeb = "command:search-web"
    case newEmail = "command:new-email"
    case newMessage = "command:new-message"
    case newFaceTime = "command:new-facetime"
    ...
    var name: String {
        ...
        case .translateScreen: return "Translate"
        ...
        case .about: return "About UltraCMD"
        case .support: return "Support UltraCMD"
        case .quit: return "Quit UltraCMD"
        }
    }
    ...
    var sfSymbol: String {
        ...
        case .quickAddEvent: return "calendar.badge.plus"
        case .newReminder: return "checklist"
        case .startTimer: return "timer"
        case .searchMaps: return "map"
        case .searchWeb: return "magnifyingglass"
        case .newEmail: return "envelope.badge"
        case .newMessage: return "bubble.left.and.bubble.right"
        case .newFaceTime: return "video"
    ...
    var isQueryDriven: Bool {
        self == .openInBrowser || self == .runShellCommand || self == .quickAddEvent
            || self == .newReminder || self == .startTimer || self == .searchMaps
            || self == .searchWeb
    }
