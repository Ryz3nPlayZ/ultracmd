    ...
    var body: some View {
        ...
        Form {
            FeatureSwitchSection(
                ...
                enableTitle: "Join meetings from UltraCMD",
                enableSubtitle:
            ...
            if settings.calendarEnabled, store.access == .notDetermined {
                Section {
                    SettingsRow(
                        ...
                        subtitle: "Allow UltraCMD to read events and find meeting links."
                    ) {
                ...
                Section {
                    SettingsRow(
                        ...
                        subtitle: "Turn UltraCMD on under Privacy & Security ▸ Calendars."
                    ) {
