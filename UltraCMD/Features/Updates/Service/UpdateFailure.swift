...
enum UpdateFailure: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .noAppInArchive:
            return "The downloaded archive does not contain UltraCMD."
        case .quarantined:
            return "macOS quarantined the downloaded app and UltraCMD could not clear the flag."
        case .bundleMismatch:
            return "The downloaded app is not this build of UltraCMD."
        case .identityMismatch:
        ...
        case .replaceFailed(let detail):
            return "UltraCMD could not be replaced. \(detail)"
        }
    }
