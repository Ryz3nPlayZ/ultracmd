...
enum CustomQuickActionError: Error, LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .invalidCharacter: return "The name contains a character UltraCMD can't store."
        case .storageUnavailable: return "UltraCMD couldn't save to its actions file."
        }
    }
}
