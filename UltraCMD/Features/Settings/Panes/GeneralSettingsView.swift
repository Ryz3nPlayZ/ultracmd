...
struct GeneralSettingsView: View {
    ...
    private var hyperSubtitle: String {
        ...
        return
            ...
            + " Hyper Key shortcuts are shown in UltraCMD with ✦."
    }
    ...
    var body: some View {
        ...
        return Form {
            ...
            Section {
                ...
                Text(
                    "UltraCMD privately learns which results you choose for each query. Reset all learned choices to restore the default order."
                )
                .font(.caption)
                .foregroundStyle(.secondary)
            }
            ...
            Section {
                ...
                if hyperTap.status == .needsAccessibility {
                    LabeledContent {
                        ...
                        Label(
                            "UltraCMD needs Accessibility access to remap keys.",
            ...
            Section {
                Picker(selection: $settings.appearance) {
                    ...
                    Text("Match macOS, or pin UltraCMD to Light or Dark.")
                }
                InterfaceSizeRow()
            ...
            Section {
                Toggle(isOn: $settings.launchAtLogin) {
                    ...
                    Text("Start UltraCMD automatically when you log in.")
                }
                Toggle(isOn: $showInMenuBar) {
                    SettingsRowTitle(.generalGeneral, "Show in menu bar")
                    Text("Keep the UltraCMD icon in the menu bar. Shortcuts still work when hidden.")
                }
        ...
        .confirmationDialog(
            ...
            Text("UltraCMD will relearn your preferred results as you use the launcher.")
        }
