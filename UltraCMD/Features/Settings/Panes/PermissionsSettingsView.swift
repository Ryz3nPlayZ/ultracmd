        ...
        Form {
            Section {
                LabeledContent {
                    ...
                    Text("Lets UltraCMD paste a clipboard item into the app you were using.")
                }
                ...
                Text("Access UltraCMD needs to work with other apps.")
                    .font(.caption)
            ...
            Section {
                LabeledContent {
                    ...
                    Text("Lets UltraCMD find the join link for the meeting you are about to be in.")
                }
