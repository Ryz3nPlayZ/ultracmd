...
enum SettingsSearchCatalog {
    ...
    private static let fallbacks: [SettingsSearchEntry] = [
        ...
        .init(
            ...
            keywords: ["google", "duckduckgo", "bing", "web", "browser"])
    ]
    ...
    private static let ai: [SettingsSearchEntry] = [
        ...
        .init(.aiChat, "Screen awareness", keywords: ["screen", "ocr", "context", "front window"]),
        .init(
    ...
    private static let calendar: [SettingsSearchEntry] = [
        ...
        .init(
            .calendarCalendar, "Join meetings from UltraCMD",
    ...
    private static let backup: [SettingsSearchEntry] = [
        ...
        .init(
            ...
            keywords: ["save", "ultracmd file", "archive"]),
        .init(
            .backupImport, "Backup File",
            keywords: ["restore", "choose", "ultracmd file"]),
        .init(
