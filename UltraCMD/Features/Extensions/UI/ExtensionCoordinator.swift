...
final class ExtensionCoordinator {
            ...
            guard
                await core.confirm(
                    ...
                    message:
                        ...
                        + "holds a JavaScript engine in memory until you leave it — expect UltraCMD "
    ...
    func showExtensionSettings(for owner: InstalledExtension) {
        ...
        NotificationCenter.default.post(
            name: .ultracmdSelectExtension, object: owner.manifest.name)
    }
...
extension Notification.Name {
    ...
    static let ultracmdSelectExtension = Notification.Name("ultracmdSelectExtension")
}
