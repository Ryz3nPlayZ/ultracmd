...
struct SymbolCategory: Identifiable, Hashable, Sendable {
    ...
    static let suggested = SymbolCategory(id: "ultracmd.suggested", title: "Suggested")
    static let all = SymbolCategory(id: "ultracmd.all", title: "All Symbols")
    static let bundled = SymbolCategory(id: "ultracmd.bundled", title: "UltraCMD")
}
