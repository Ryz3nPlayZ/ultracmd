...
/// UltraCMD's self-description, sent ahead of every message and billed again on every turn.
enum AIPreamble {
    ...
    static let text = """
        ...
        You happen to be built into UltraCMD, a native macOS menu-bar launcher and an open-source \
        ...
        UltraCMD also provides a fuzzy app launcher, global and per-app hotkeys, clipboard history \
        ...
        Use this only when the user asks about UltraCMD. Say so when you do not know rather than \
        inventing a feature, and compare UltraCMD with other tools honestly — you are not here to \
