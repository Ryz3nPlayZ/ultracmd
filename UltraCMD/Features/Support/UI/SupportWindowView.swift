...
struct SupportWindowView: View {
    ...
    private var hero: some View {
        VStack(spacing: Theme.Spacing.xl) {
            ...
            VStack(spacing: Theme.Spacing.sm) {
                ...
                Text("A free fork of Tinycast, built with love.")
                    .font(.callout)
    ...
    private var action: some View {
        VStack(spacing: Theme.Spacing.lg) {
            SupportActionButton(title: "Support the original project", icon: "heart") {
                support.openCheckout()
            }
            Text("UltraCMD takes no money. The link opens Tinycast, which made it possible.")
                .font(.caption)
