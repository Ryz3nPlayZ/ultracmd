...
enum Theme {
    enum Spacing {
        ...
        /// Outer inset of UltraCMD's dialog content.
    ...
    enum Size {
        ...
        /// UltraCMD's own control dialog: fixed width, height measured from its SwiftUI content.
    ...
    /// Motion owned by UltraCMD's menus; extension-provided panels keep their own behavior.
    @MainActor
    enum MenuMotion {
    ...
    enum Colors {
        ...
        /// Modal separation inside UltraCMD: the launcher recedes while its dialog is in front.
