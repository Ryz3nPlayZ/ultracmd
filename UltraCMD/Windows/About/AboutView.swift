...
private struct AboutLink: Identifiable {
    ...
    static let all: [AboutLink] = [
        AboutLink(
            ...
            detail: "ultracmd.dev",
            url: URL(string: "https://ultracmd.dev/")!),
        AboutLink(
            id: "github", glyph: .brand("BrandGitHub"), title: "GitHub",
            detail: "github.com/abue-ammar/ultracmd",
            url: URL(string: "https://github.com/abue-ammar/ultracmd")!),
        AboutLink(
            id: "discord", glyph: .brand("BrandDiscord"), title: "Discord",
            detail: "Join the UltraCMD community",
