...
activation policy, since opening About flips UltraCMD itself to `.regular`.
...
front**. Capturing from Settings marks nothing, because UltraCMD itself is frontmost then.
