...
searchable by name and runnable with ↵, a favorite slot or a global shortcut. UltraCMD lists and runs
...
UltraCMD wasn't running is caught too — sweeps. `AppleShortcut.staleIDs` collects every
...
lines in UltraCMD's own dialog.
