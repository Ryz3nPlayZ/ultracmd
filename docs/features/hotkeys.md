...
to re-register from
and to prune bindings whose record was deleted while UltraCMD wasn't running. That prune is why
...
window — that is un-remapped HID behaviour, not something UltraCMD can stop.
