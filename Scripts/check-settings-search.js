...
const ANCHORS = "UltraCMD/Features/Settings/SettingsAnchor.swift";
const CATALOG = "UltraCMD/Features/Settings/SettingsSearchCatalog.swift";
...
const source = swiftSources(path.join(ROOT, "UltraCMD"))
