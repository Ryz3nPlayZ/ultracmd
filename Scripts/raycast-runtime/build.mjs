// Bundles the embedded extension runtime into UltraCMD/Resources/RaycastRuntime.generated.js.
//
//   pnpm install && node gen-enums.mjs && node build.mjs
//
// The output is committed (like EmojiData.generated.swift) so building UltraCMD never needs Node.

import { build } from "esbuild";
import { mkdirSync, statSync, writeFileSync } from "node:fs";
import { dirname, resolve } from "node:path";

const outFile = resolve("../../UltraCMD/Resources/RaycastRuntime.generated.js");
...
// `__ultracmdCompile` has to compile in the *global* scope so the extension bundle it evaluates can't
