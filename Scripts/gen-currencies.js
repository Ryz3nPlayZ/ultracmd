#!/usr/bin/env node
// Generate UltraCMD/Features/Calculator/Model/CurrencyData.generated.swift.
//
...
async function main() {
  ...
  const out = path.resolve(__dirname, "..", "UltraCMD/Features/Calculator/Model/CurrencyData.generated.swift");
